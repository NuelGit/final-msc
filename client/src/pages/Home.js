  ...
  return (
    <div className="home-container">
      ...
      <p>
        ...
        <strong> Ebele Emmanuel Nweke</strong>. <br /> under the supervision of
      ...
      <p>
        To get started, please log in or register if you don't have an account
        yet. Once logged in, you'll have access to the dashboard, file
